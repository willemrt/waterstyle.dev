                ...
                <# } #>
					...
					<span class="restore">
                        <#
                            ...
                            ( typeof DDLayout_settings_editor !== 'undefined' &&
                            typeof DDLayout_settings_editor.user_can_create !== 'undefined' &&
                            +DDLayout_settings_editor.user_can_create === 0 )
                            )
                            { #>
                                                                ...
                                                                <div class="ddl-dialogs-container">
                                                                    <div
                                                                        ...
                                                                        <div class="ddl-dialog-footer">
                                                                            ...
                                                                            <button
                                                                                class="button js-edit-dialog-close close-change-use"><?php _e('Close', 'ddl-layouts') ?></button>

...
<li> <div class="alert-no-loops toolset-alert <?php if( $has_loop ):?>hidden<?php endif;?>">
       <!-- <i class="fa fa-remove icon-remove js-remove-alert-message remove-alert-message" data-has_right_cell="<?php echo $has_loop; ?>"></i> -->
        <?php echo sprintf( __("This layout doesn't have a Wordpress Archive cell, so you cannot use it for archives. %s",

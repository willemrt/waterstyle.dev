...
<?php endforeach; ?>
   <li class="save-archives-options-wrap"> <input data-group="<?php echo WPDD_layout_post_loop_cell_manager::WORDPRESS_OTHERS_SECTION; ?>" disabled id="js-save-archives-options-<?php echo $current;?>" name="save_archives_options" class="button button-secondary button-large js-save-others-options js-buttons-change-update buttons-change-update" value="<?php _e('Update', 'ddl-layouts');?>" type="submit"></li>
</ul>
</div>
<?php endif;?>
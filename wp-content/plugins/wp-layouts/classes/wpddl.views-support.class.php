			...
			if ($pagenow == 'plugins.php' ||
				...
				if ( ! get_user_meta($user_id, 'views_required_ignore_notice') ) {
					...
					<div class="update-nag">
						<p>
                            <i class="icon-views-logo ont-color-orange ont-icon-24"></i>&nbsp;<strong><span style="vertical-align: -6px"><?php _e('Get more from Layouts with the Views plugin.'); ?></span></strong>
						</p>
						<p>

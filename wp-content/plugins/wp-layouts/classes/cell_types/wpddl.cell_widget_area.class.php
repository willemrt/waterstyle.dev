...
class WPDD_layout_cell_widget_area_factory extends WPDD_layout_cell_factory{
	...
	public function get_cell_info($template) {
		...
		$template['name'] = __('Widget zone', 'ddl-layouts');
		$template['description'] = __('Display a WordPress Widgets area. You will be able to select a widgets area that comes from the theme.', 'ddl-layouts');

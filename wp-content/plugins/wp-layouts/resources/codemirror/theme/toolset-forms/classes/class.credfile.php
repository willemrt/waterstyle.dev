...
class WPToolset_Field_Credfile extends WPToolset_Field_Textfield {
    ...
    public function init() {
        ...
        if ($this->enable_progress_bar) {
            ...
            wp_localize_script('my_ajax_file_uploader', 'settings', array('media_settings' => Toolset_Utils::get_image_sizes('thumbnail'), 'ajaxurl' => plugins_url("submit.php", __FILE__), 'nonce' => wp_create_nonce('ajax_nonce')));
        }
    }

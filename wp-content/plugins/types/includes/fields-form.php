...
function wpcf_admin_fields_form()
{
    ...
    if ( $current_user_can_edit ) {
        ...
        $form['help-icon'] = array(
            ...
            . '/toolset/toolset-common/res/images/question.png" style="position:relative;top:2px;" />&nbsp;<a href="http://wp-types.com/documentation/user-guides/using-custom-fields/?utm_source=typesplugin&utm_medium=help&utm_term=fields-help&utm_content=fields-editor&utm_campaign=types" target="_blank">'

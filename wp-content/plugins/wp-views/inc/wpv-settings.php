...
class WPV_Settings extends WPV_Settings_Embedded {
    ...
    function init() {
		...
		add_action( 'wpv_action_views_settings_features_section', array( $this, 'wpv_codemirror_options' ), 60 );
        ...
        wp_register_style( 'views-admin-css', WPV_URL_EMBEDDED . '/res/css/views-admin.css', array( 'font-awesome', 'toolset-colorbox', 'views-notifications-css', 'views-admin-dialogs-css', 'select2' ), WPV_VERSION );
    ...
    function wpv_settings_admin() {
        ...
        <div class="wrap">
            ...
            <h1><?php _e( 'Views Settings', 'wpv-views' ) ?></h1>
    ...
    function wpv_map_plugin_options( $options ) {
        ...
        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2><?php _e( 'Map plugin', 'wpv-views' ); ?></h2>
            </div>
    ...
    function wpv_show_hidden_custom_fields_options( $options ) {
        ...
        <div class="wpv-setting-container wpv-settings-hidden-cf js-wpv-setting-container">
            ...
            <div class="wpv-settings-header">
                <h2><?php _e( 'Hidden custom fields', 'wpv-views' ); ?></h2>
            </div>

            <div class="wpv-setting">

                <div class="js-wpv-hidden-cf-summary">
                    <?php
                    $cf_exists = false;
                    ...
                    ?>
                    <p class="js-wpv-hidden-cf-exists-message <?php echo $cf_exists ? '' : 'hidden'; ?>">
                        <?php _e( 'The following private custom fields are showing in the Views GUI:', 'wpv-views' ); ?>
                    </p>
                    <p class="js-wpv-no-hidden-cf-message <?php echo $cf_exists ? 'hidden' : ''; ?>">
                        <?php _e( 'No private custom fields are showing in the Views GUI.', 'wpv-views' ); ?>
                    </p>
                    <ul class="wpv-selected-cf-list wpv-taglike-list js-wpv-selected-hidden-cf-list <?php echo $cf_exists ? '' : 'hidden'; ?>">
                    ...
                    <p class="update-button-wrap">
                        <button class="button-secondary js-wpv-show-hidden-cf-list" type="button"><?php _e( 'Edit', 'wpv-views' ); ?></button>
                        <span class="toolset-alert toolset-alert-success hidden js-wpv-hidden-cf-update-message">
                ...
                <div class="js-wpv-hidden-cf-toggle hidden">

                    <?php $meta_keys = $WP_Views->get_hidden_meta_keys(); ?>
                    <ul class="cf-list wpv-mightlong-list js-wpv-all-hidden-cf-list">
                    ...
                    <p class="update-button-wrap">
                        <button class="button-secondary js-wpv-hide-hidden-cf-list"><?php _e( 'Cancel', 'wpv-views' ); ?></button>
                        <button class="button-secondary js-wpv-save-hidden-cf-list" disabled="disabled"><?php _e( 'Save', 'wpv-views' ); ?></button>
                    </p>
	...
	function wpv_show_hidden_toolset_admin_bar_menu( $options ) {
        ...
        <div>
            <div id="toolset-admin-bar-settings" class="wpv-setting-container js-wpv-setting-container">
                <div class="wpv-settings-header">
                    <h2><?php _e( 'Toolset Admin Bar Menu', 'wpv-views' ); ?></h2>
                </div>
                <div class="wpv-setting">
                    <p>
    ...
    function wpv_bootstrap_options( $options ) {
        ...
        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2><?php _e( 'Bootstrap Layouts', 'wpv-views' ); ?></h2>
            </div>
            <div class="wpv-setting">
                <p>
    ...
    function wpv_custom_inner_shortcodes_options( $options ) {
        ...
        <div class="wpv-setting-container wpv-settings-shortcodes wpv-add-item-settings js-wpv-setting-container">
            ...
            <div class="wpv-settings-header">
                <h2><?php _e( 'Third-party shortcode arguments', 'wpv-views' ); ?></h2>
            </div>
                            ...
                            if ( count( $custom_shrt ) > 0 ) {
                                ...
                                foreach ( $custom_shrt as $custom_shrtcode ) {
                                    ...
                                    <li class="js-<?php echo $custom_shrtcode; ?>-item">
                                        ...
                                        <i class="icon-remove-sign fa fa-times-circle js-wpv-custom-shortcode-delete" data-target="<?php echo $custom_shrtcode; ?>"></i>
                                    </li>
                                    <?php
                                }
                            }
    ...
    function wpv_custom_conditional_functions( $options ) {
        ...
        <div class="wpv-setting-container wpv-settings-functions wpv-add-item-settings js-wpv-setting-container">
            ...
            <div class="wpv-settings-header">
                <h2><?php _e( 'Functions inside conditional evaluations', 'wpv-views' ); ?></h2>
            </div>
    ...
    function wpv_wpml_translation_options() {
		...
		?>
            ...
            <div class="wpv-setting-container js-wpv-setting-container">
                ...
                <div class="wpv-settings-header">
                    <h2><?php _e( 'Translating with WPML', 'wpv-views' ); ?></h2>
                </div>
    ...
    function wpv_edit_view_frontend_links_options( $options ) {
        ...
        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2><?php _e( 'Frontend Edit Links', 'wpv-views' ); ?></h2>
            </div>
            <div class="wpv-setting">
                <p>
	...
	function wpv_codemirror_options( $options ) {
        ?>

        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2><?php _e( 'Syntax highlighting options', 'wpv-views' ); ?></h2>
            </div>
            <div class="wpv-setting">
				<p>
                ...
                <ul class="">
                    <li>
                        <label>
                            <input id="js-wpv-codemirror-autoresize" type="checkbox" name="wpv-codemirror-autoresize" class="js-wpv-codemirror-autoresize" value="1" <?php checked( $this->wpv_codemirror_autoresize == 1 ); ?> autocomplete="off" />
                ...
                <p class="update-button-wrap">
                    <span class="js-wpv-messages"></span>
                    <button class="js-wpv-codemirror-settings-save button-secondary" disabled="disabled">
                        <?php _e( 'Save', 'wpv-views' ); ?>
                    </button>
                </p>
            </div>
    ...
    function admin_settings( $options ) {
        ...
        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2><?php _e( 'Theme support for Content Templates', 'wpv-views' ); ?></h2>
            </div>
            <div class="wpv-setting">
    ...
    function wpv_debug_options( $options ) {
        ...
        <div class="wpv-setting-container js-wpv-setting-container">
            <div class="wpv-settings-header">
                <h2 id="debug_mode"><?php _e( 'Debug mode', 'wpv-views' ); ?></h2>
            </div>
            <div class="wpv-setting">
                <p>
                                    ...
                                    <script type="text/javascript">
                                        function wpv_open_test_popup() {
											...
											if ( 
												...
												var debug_info = jQuery('.js-debuger-test-output').clone().html();
	...
	*/
    ...
    function wpv_get_show_hidden_custom_fields() {
		...
		if (
			! isset( $_POST['wpv_show_hidden_fields'] ) 
			|| is_array( $_POST['wpv_show_hidden_fields'] ) 
		) {
	...
	function wpv_update_codemirror_status() {
		...
		$this->wpv_codemirror_autoresize = ( $autoresize == 'true' ) ? 1 : 0;
		$this->save();
		wp_send_json_success();
	}
	...
	*/
    ...
    function wpv_update_custom_inner_shortcodes() {
		...
		if ( 
			isset( $this->wpv_custom_inner_shortcodes ) 
			&& is_array( $this->wpv_custom_inner_shortcodes ) 
		) {
	...
	*/
	...
	function wpv_filter_wpv_codemirror_autoresize( $status ) {
		if ( $this->wpv_codemirror_autoresize ) {
			$status = true;
		} else {
			$status = false;
		}

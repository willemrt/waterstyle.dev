				...
				<div data-bind="visible:fieldRaw">
					...
					<table data-bind="visible:userValuesVisible">
						...
						<tbody data-bind="sortable: { data: values, options: { handle: '.sortable-handle' } }">
							<tr>
								<td>
									<i class="icon-move fa fa-arrows sortable-handle"></i>
								</td>
								<td>
								...
								<td class="remove-sign-wrap">
									<i class="icon-remove-sign fa fa-times-circle js-action-name" data-bind="click:$root.remove_user_values_box"></i>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<p data-bind="visible:userValuesVisible" class="prm-button-holder alignright" >
						<button data-bind="visible:userValuesVisible, click:add_user_values_box" class="button-secondary"><i class="icon-plus fa fa-plus" id="js_parametric_another_value"></i> <?php _e('Add another value', 'wpv-views');?></button>
					</p>

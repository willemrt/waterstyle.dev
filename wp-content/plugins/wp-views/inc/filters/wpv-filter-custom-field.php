			...
			<div class="wpv-filter-multiple-element-options-mode js-wpv-custom-field-values">
				...
				foreach ( $parts as $i => $value_part ) {
					...
					<div class="wpv_custom_field_value_div js-wpv-custom-field-value-div">
						...
						<button class="button-secondary js-wpv-custom-field-remove-value"><i class="icon-remove fa fa-times"></i> <?php echo __( 'Remove', 'wpv-views' ); ?></button>
					</div>
					<?php
				}
				?>
				<button class="button button-secondary js-wpv-custom-field-add-value" style="margin-top:10px;"><i class="icon-plus fa fa-plus"></i> <?php echo __( 'Add another value', 'wpv-views' ); ?></button>
			</div>
	<?php
	}

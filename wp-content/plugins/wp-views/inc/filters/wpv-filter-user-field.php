			...
			<div class="wpv-filter-multiple-element-options-mode js-wpv-usermeta-field-values">
				...
				foreach ( $parts as $i => $value_part ) {
					...
					<div class="wpv_usermeta_field_value_div js-wpv-usermeta-field-value-div">
						...
						<button class="button-secondary js-wpv-usermeta-field-remove-value"><i class="icon-remove fa fa-times"></i> <?php echo __( 'Remove', 'wpv-views' ); ?></button>
					</div>
					<?php
				}
				?>
				<button class="button-secondary js-wpv-usermeta-field-add-value" style="margin-top:10px;"><i class="icon-plus fa fa-plus"></i> <?php echo __( 'Add another value', 'wpv-views' ); ?></button>
			</div>
	<?php
	}

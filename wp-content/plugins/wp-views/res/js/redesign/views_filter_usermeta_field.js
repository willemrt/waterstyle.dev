...
WPViews.UsermetaFieldFilterGUI = function( $ ) {
	...
	*/
	...
	self.init_dialogs = function() {
		self.filter_dialog = $( "#js-wpv-filter-usermeta-field-delete-filter-row-dialog" ).dialog({
			autoOpen: false,
			modal: true,
			title: wpv_usermeta_field_filter_texts.dialog_title,
			minWidth: 600,
			show: { 
				effect: "blind", 
				duration: 800 
			...
			buttons:[
				{
					...
					text: wpv_usermeta_field_filter_texts.cancel,
					click: function() {
						$( this ).dialog( "close" );
					}
				},
				{
					class: 'button-secondary',
					text: wpv_usermeta_field_filter_texts.edit_filters,
					click: function() {
						$( this ).dialog( "close" );
				...
				},
				{
					...
					text: wpv_usermeta_field_filter_texts.delete_filters,
					click: function() {
						self.remove_usermeta_field_filters();
						$( this ).dialog( "close" );
					}

...
/**
* wpv_filter_register_post_relationship_url_parameters
*
...
add_filter( 'wpv_filter_register_url_parameters_for_posts', 'wpv_filter_register_post_relationship_url_parameters', 10, 2 );

function wpv_filter_register_post_relationship_url_parameters( $attributes, $view_settings ) {
	if (
		isset( $view_settings['post_relationship_mode'] ) 
		&& isset( $view_settings['post_relationship_mode'][0] ) 

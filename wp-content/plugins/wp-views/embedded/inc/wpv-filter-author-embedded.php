...
/**
* wpv_filter_register_post_author_url_parameters
*
...
add_filter( 'wpv_filter_register_url_parameters_for_posts', 'wpv_filter_register_post_author_url_parameters', 10, 2 );

function wpv_filter_register_post_author_url_parameters( $attributes, $view_settings ) {
	if (
		isset( $view_settings['author_mode'] ) 
		&& isset( $view_settings['author_mode'][0] ) 

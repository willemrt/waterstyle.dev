...
abstract class WPV_Embedded_ViewsPostType_ItemProvider_Decorator implements IWPV_ItemProvider_Decorator {
    ...
    /**
     * @var string|array View query mode. @see wpv_prepare_view_listing_query() for allowed values and their explanation.
     */
     ...
     *
     * @param $view_query_mode string|array View query mode. @see wpv_prepare_view_listing_query().
     *
...
class WPV_Embedded_WPA_Item_Provider_Decorator extends WPV_Embedded_ViewsPostType_ItemProvider_Decorator
{
    ...
    public function __construct() {
        parent::__construct( WPV_WordPress_Archive_Embedded::get_possible_query_modes() );
    }
...
class WPV_Embedded_View_Item_Provider_Decorator extends WPV_Embedded_ViewsPostType_ItemProvider_Decorator {
     ...
     */
    public function __construct() {
        parent::__construct( WPV_View_Embedded::get_possible_query_modes() );
    }

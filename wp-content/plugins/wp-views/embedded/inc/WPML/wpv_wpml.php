...
/**
 * Filter hooked into wpv_custom_inner_shortcodes. Add the [wpml-string] shortcode to the allowed inner shortcodes, even if the [wpml-string] shortcode itself does not exist
 *

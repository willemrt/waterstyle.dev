...
foreach ( $items as $item_id => $item ) :
	...
	if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
        ...
        <td class="td" style="text-align:left; vertical-align:middle; border: 1px solid #eee; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;"><?php if ( ! $order->has_status( 'quote' ) ) echo $order->get_formatted_line_subtotal( $item ); ?></td>
	</tr>
	<?php } ?>

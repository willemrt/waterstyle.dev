...
{	
	 ...
	 * @var string
	 */
	private $menu_slug = 'quotes-orders-mode';
	...
	public function page_data() {
		...
		$page_data = array( 
			array(
				'type'				=> 'menu',
				'page_title'		=> __( 'Quotes & Orders', 'wc_email_inquiry' ),
				'menu_title'		=> __( 'Quotes & Orders', 'wc_email_inquiry' ),
			...
			array(
				...
				'page_title'		=> __( 'Settings', 'wc_email_inquiry' ),
				'menu_title'		=> __( 'Settings', 'wc_email_inquiry' ),
				'capability'		=> 'manage_options',
				'menu_slug'			=> $this->menu_slug,
				'function'			=> 'wc_ei_settings_page_show',
				'admin_url'			=> 'admin.php',
	...
	public function tabs_include() {
		...
		include_once( $this->admin_plugin_dir() . '/tabs/read-more-tab.php' );

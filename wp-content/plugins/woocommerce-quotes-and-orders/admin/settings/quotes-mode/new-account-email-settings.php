...
class WC_EI_Quotes_Mode_New_Account_Email_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function __construct() {
		...
		if ( version_compare( $wc_db_version, '2.5.0', '>=' ) ) {
			$this->template_html 	= 'emails/quote-new-account_2.5.php';
			$this->template_plain 	= 'emails/plain/quote-new-account_2.5.php';
		}
		...
		add_action( $this->plugin_name . '_settings_' . 'quote_new_account_email_table' . '_start', array( $this, 'add_email_template_shortcodes' ) );

	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
                ...
                'type' 		=> 'heading',
                'id'		=> 'wc_ei_quote_product_page_box',
                'is_box'	=> true,
           	),
			array(  
			...
			array(
                ...
                'type' 		=> 'heading',
                'id'		=> 'wc_ei_quote_success_message_box',
                'is_box'	=> true,
           	),
			array(  
				'name' 		=> __( 'Success Message', 'wc_email_inquiry' ),
				...
				'type' 		=> 'text',
				'default'	=> __( '%s has been added to your quote.', 'wc_email_inquiry' ),
			),
			array(  
				...
				'type' 		=> 'text',
				'default'	=> __( '%s have been added to your quote.', 'wc_email_inquiry' ),
			),
			
			array(
            	'name' 		=> __( 'Error Message', 'wc_email_inquiry' ),
                'type' 		=> 'heading',
                'id'		=> 'wc_ei_quote_error_message_box',
                'is_box'	=> true,
           	),
			array(  

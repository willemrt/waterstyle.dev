...
class WC_EI_Button_Style_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function after_save_settings() {
		...
		if ( isset( $_POST['bt_save_settings'] ) && isset( $_POST['wc_ei_product_reset_button_settings'] ) ) {
			delete_option( 'wc_ei_product_reset_button_settings' );
			WC_Email_Inquiry_Functions::reset_products_ei_button_settings();
		}
	}
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'button-style',
			'label'				=> __( 'Inquiry Button Style', 'wc_email_inquiry' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'desc' 		=> __( "Leave Empty and button text will be 'Product Enquiry'", 'wc_email_inquiry' ),
			...
			array(
            	'name' 		=> __( 'Inquiry Button Global Reset', 'wc_email_inquiry' ),
                'type' 		=> 'heading',
                'id'		=> 'wc_ei_reset_button_style_box',
                'is_box'	=> true,
           	),
			array(  
				'name' 		=> __( 'Button Reset', 'wc_email_inquiry' ),
				'desc' 		=> __( "Switch ON and Save changes to update all Products email inquiry button settings back to the Global settings created on this page.", 'wc_email_inquiry' )
				.'<br />'.__( "<strong>Important</strong> Clear your cache after so that visitors see changes.", 'wc_email_inquiry' ),
				'id' 		=> 'wc_ei_product_reset_button_settings',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 'no',

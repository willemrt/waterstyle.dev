...
class WC_EI_Orders_Mode_New_Account_Email_Settings extends WC_Email_Inquiry_Admin_UI
{
	...
	public function __construct() {
		...
		if ( version_compare( $wc_db_version, '2.5.0', '>=' ) ) {
			$this->template_html 	= 'emails/order-new-account_2.5.php';
			$this->template_plain 	= 'emails/plain/order-new-account_2.5.php';
		}
		...
		add_action( $this->plugin_name . '_settings_' . 'order_new_account_email_table' . '_start', array( $this, 'add_email_template_shortcodes' ) );
	...
	?>
    		<tr valign="top">
                ...
                <td rowspan="3">
                    	<?php _e( 'New account email template available shortcodes', 'wc_email_inquiry' ); ?>:<br />
                        <?php
		...
		unset( $roles['auto_quote'] );
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
                ...
                'type' 		=> 'heading',
                'id'		=> 'wc_ei_order_new_account_role_box',
                'is_box'	=> true,
           	),
			array(  
